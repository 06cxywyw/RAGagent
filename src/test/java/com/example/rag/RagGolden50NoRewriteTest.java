...
@SpringBootTest
@ActiveProfiles("dev")
public class RagGolden50NoRewriteTest {
    ...
    void evaluate_noRewrite() {
        ...
        GoldenEvaluationSupport.printReport("黄金50 单测：禁用 Query Rewrite", cfg, r, ks);
    }
}
