...
[面试官：多节点争抢资源， Redis 分布式锁是怎么实现的？](https://mp.weixin.qq.com/s/SXDJpOphGTy1NLeEAL9FbA)
...
Redlock 算法的执行步骤如下：
- 向 N 个独立的 Redis 锁节点依次发送SET NX EX加锁请求，实际应用中通常会部署 5 个；
- 统计成功给资源加锁的节点数量，若成功数量超过 N/2，比如部署 5 个节点时至少有 3 个成功，就判定加锁成功；
