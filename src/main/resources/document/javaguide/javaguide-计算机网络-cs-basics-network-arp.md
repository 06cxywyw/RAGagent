...
> 来源: https://javaguide.cn/cs-basics/network/arp.html

# ARP 协议详解(网络层)
[Guide](https://javaguide.cn/article/)计算机基础计算机网络约 2770 字大约 9 分钟IP 地址负责网络层寻址，但数据帧在局域网里真正转发时，还需要知道下一跳设备的 MAC 地址。
...
- ARP 在协议栈中处于什么位置？
- ARP 如何通过广播问询、单播响应完成地址解析？
- ARP 表有什么作用，缓存过期会带来什么影响？
- 常见 ARP 攻击是怎么发生的，又该如何防御？
...
![](https://javaguide.cn/assets/arp_different_lan-LU_pQWQV.png)
