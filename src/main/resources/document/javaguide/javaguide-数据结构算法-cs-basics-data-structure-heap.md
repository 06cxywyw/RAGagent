...
> 来源: https://javaguide.cn/cs-basics/data-structure/heap.html

# 堆详解（最大堆、最小堆、优先队列）
[Guide](https://javaguide.cn/article/)计算机基础数据结构约 2814 字大约 9 分钟
# 堆
...
- （二叉）堆是一个数组，它可以被看成是一个近似的完全二叉树。——《算法导论》第三版

大家可以尝试判断下面给出的图是否是堆？

![](https://javaguide.cn/assets/%E5%A0%861-XFna5NAD.png)
...
相对于有序数组而言，堆的主要优势在于插入和删除数据效率较高。因为堆是基于完全二叉树实现的，所以在插入和删除数据时，只需要在二叉树中上下移动节点，时间复杂度为O(log(n))，相比有序数组的O(n)，效率更高。

不过，需要注意的是：Heap 初始化的时间复杂度为O(n)，而非O(nlogn)。
...
![](https://javaguide.cn/assets/%E5%A0%862-m3vzmcJq.png)

---
## 堆的存储
之前介绍树的时候说过，由于完全二叉树的优秀性质，利用数组存储二叉树即节省空间，又方便索引（若根结点的序号为 1，那么对于树中任意节点 i，其左子节点序号为2*i，右子节点序号为2*i+1）。

为了方便存储和索引，（二叉）堆可以用完全二叉树的形式进行存储。存储的方式如下图所示：

![堆的存储](https://javaguide.cn/assets/%E5%A0%86%E7%9A%84%E5%AD%98%E5%82%A8-ZtlPcDkw.png)
...
![堆-插入元素-1](https://javaguide.cn/assets/%E5%A0%86-%E6%8F%92%E5%85%A5%E5%85%83%E7%B4%A01-BPujJrza.png)

有能力的人会逐渐升职加薪，是金子总会发光的！！！

2. 从底向上，如果父结点比该元素小，则该节点和父结点交换，直到无法交换

![堆-插入元素2](https://javaguide.cn/assets/%E5%A0%86-%E6%8F%92%E5%85%A5%E5%85%83%E7%B4%A02-BEh76gJ1.png)

![堆-插入元素3](https://javaguide.cn/assets/%E5%A0%86-%E6%8F%92%E5%85%A5%E5%85%83%E7%B4%A03-Cn6KG4Li.png)
...
![删除堆顶元素1](https://javaguide.cn/assets/%E5%88%A0%E9%99%A4%E5%A0%86%E9%A1%B6%E5%85%83%E7%B4%A01-y1Q3jmob.png)

那么他的位置由谁来接替呢，当然是他的直接下属了，谁能力强就让谁上呗

比较根结点的左子节点和右子节点，也就是下标为 2,3 的数组元素，将较大的元素填充到根结点（下标为 1）的位置。

![删除堆顶元素2](https://javaguide.cn/assets/%E5%88%A0%E9%99%A4%E5%A0%86%E9%A1%B6%E5%85%83%E7%B4%A02-DCeYIHuE.png)

这个时候又空出一个位置了，老规矩，谁有能力谁上

一直循环比较空出位置的左右子节点，并将较大者移至空位，直到堆的最底部

![删除堆顶元素3](https://javaguide.cn/assets/%E5%88%A0%E9%99%A4%E5%A0%86%E9%A1%B6%E5%85%83%E7%B4%A03-DuCFYmPz.png)
...
![删除堆顶元素4](https://javaguide.cn/assets/%E5%88%A0%E9%99%A4%E5%A0%86%E9%A1%B6%E5%85%83%E7%B4%A04-bmIZsQyc.png)

然后开始将这个石头沉入海底，不停与左右子节点的值进行比较，和较大的子节点交换位置，直到无法交换位置。

![删除堆顶元素5](https://javaguide.cn/assets/%E5%88%A0%E9%99%A4%E5%A0%86%E9%A1%B6%E5%85%83%E7%B4%A05-Dloq2ahz.png)

![删除堆顶元素6](https://javaguide.cn/assets/%E5%88%A0%E9%99%A4%E5%A0%86%E9%A1%B6%E5%85%83%E7%B4%A06-D4cLQTzP.png)
...
![建堆1](https://javaguide.cn/assets/%E5%BB%BA%E5%A0%861-Bfn9WEXK.png)

将初始的无序数组抽象为一棵树，图中的节点个数为 6，所以 4,5,6 节点为叶节点，1,2,3 节点为非叶节点，所以要对 1-3 号节点进行自顶向下（沉底）堆化，注意，顺序是从后往前堆化，从 3 号节点开始，一直到 1 号节点。

3 号节点堆化结果：

![建堆1](https://javaguide.cn/assets/%E5%BB%BA%E5%A0%862-B2f1Atqe.png)

2 号节点堆化结果：

![建堆1](https://javaguide.cn/assets/%E5%BB%BA%E5%A0%863-BKxkjwaN.png)

1 号节点堆化结果：

![建堆1](https://javaguide.cn/assets/%E5%BB%BA%E5%A0%864-CiqR7HAx.png)
