...
> 来源: https://javaguide.cn/java/basis/bigdecimal.html

# BigDecimal 详解
[Guide](https://javaguide.cn/article/)JavaJava基础约 2263 字大约 8 分钟《阿里巴巴 Java 开发手册》中提到：“为了避免精度丢失，可以使用BigDecimal来进行浮点数的运算”。
...
---
## BigDecimal 介绍
BigDecimal可以实现对小数的运算，不会造成精度丢失。

通常情况下，大部分需要小数精确运算结果的业务场景（比如涉及到钱的场景）都是通过BigDecimal来做的。
...
想要解决浮点数运算精度丢失这个问题，可以直接使用BigDecimal来定义小数的值，然后再进行小数的运算操作即可。
