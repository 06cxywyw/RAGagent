...
> 来源: https://javaguide.cn/java/collection/priorityqueue-source-code.html

# PriorityQueue 源码分析（付费）
[Guide](https://javaguide.cn/article/)JavaJava集合约 153 字小于 1 分钟PriorityQueue 源码分析为我的[知识星球](https://javaguide.cn/about-the-author/zhishixingqiu-two-years.html)（点击链接即可查看详细介绍以及加入方法）专属内容，已经整理到了[《Java 必读源码系列》](https://javaguide.cn/zhuanlan/source-code-reading.html)中。
