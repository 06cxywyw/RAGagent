...
> 来源: https://javaguide.cn/java/basis/why-there-only-value-passing-in-java.html

# Java 值传递详解
[Guide](https://javaguide.cn/article/)JavaJava基础约 1629 字大约 5 分钟开始之前，我们先来搞懂下面这两个概念：
...
---
## 引用传递是怎么样的？
看到这里，相信你已经知道了 Java 中只有值传递，是没有引用传递的。但是，引用传递到底长什么样呢？下面以C++的代码为例，让你看一下引用传递的庐山真面目。
