...
> 来源: https://javaguide.cn/java/new-features/java17.html

# Java 17 新特性概览（重要）
[Guide](https://javaguide.cn/article/)JavaJava新特性约 1901 字大约 6 分钟Java 17 在 2021 年 9 月 14 日正式发布，是一个长期支持（LTS）版本。
...
JDK 17 之前，我们可以借助Random、ThreadLocalRandom和SplittableRandom来生成随机数。不过，这 3 个类都各有缺陷，且缺少常见的伪随机算法支持。
