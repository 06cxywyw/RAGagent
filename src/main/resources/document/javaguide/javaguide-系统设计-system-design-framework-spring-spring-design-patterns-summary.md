...
> 来源: https://javaguide.cn/system-design/framework/spring/spring-design-patterns-summary.html

# Spring 中的设计模式详解
[Guide](https://javaguide.cn/article/)框架Spring约 4414 字大约 15 分钟“JDK 中用到了哪些设计模式? Spring 中用到了哪些设计模式? ”这两个问题，在面试中比较常见。
