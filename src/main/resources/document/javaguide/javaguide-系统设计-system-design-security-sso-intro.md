...
> 来源: https://javaguide.cn/system-design/security/sso-intro.html

# SSO 单点登录详解
[Guide](https://javaguide.cn/article/)系统设计安全约 1420 字大约 5 分钟本文授权转载自：[https://ken.io/note/sso-design-implement](https://ken.io/note/sso-design-implement)作者：[ken.io](http://ken.io)
...
按照上图，用户登录后 AuthToken 保存在 Cookie 中。[domain=test.com](http://domain=test.com)浏览器会将 domain 设置成 .test.com，
