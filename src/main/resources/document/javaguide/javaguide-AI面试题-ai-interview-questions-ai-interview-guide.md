...
> 来源: https://javaguide.cn/ai/interview-questions/ai-interview-guide.html

# 2026 大模型面试题 | Agent 面试题 | RAG 面试题 | AI 应用开发面试指南（含答案与图解）
[Guide](https://javaguide.cn/article/)AIAI面试大模型面试Agent面试RAG面试约 3645 字大约 12 分钟[![JavaGuide 官方知识星球](https://oss.javaguide.cn/xingqiu/xingqiu.png)](https://javaguide.cn/about-the-author/zhishixingqiu-two-years.html)
...
| --- | --- | --- |
| [大模型基础面试题总结](https://javaguide.cn/ai/interview-questions/llm-interview-questions.html) | 所有准备 AI 应用开发面试的人 | Token、上下文窗口、采样参数、API 调用、流式输出、结构化输出、Function Calling、AI 应用评测 |
| [AI Agent 面试题总结](https://javaguide.cn/ai/interview-questions/agent-interview-questions.html) | 准备 Agent、工具调用、工作流相关岗位的人 | Agent Loop、Memory、Prompt Engineering、Context Engineering、MCP、Agent Skills、Harness Engineering、Workflow、Graph、Loop |
| [RAG 面试题总结](https://javaguide.cn/ai/interview-questions/rag-interview-questions.html) | 准备知识库问答、企业 AI 应用、搜索增强生成相关岗位的人 | RAG 基础、Embedding、向量数据库、Chunk 策略、Hybrid Search、Query Rewrite、Rerank、GraphRAG、知识库更新与评测 |
| [AI 系统设计面试题总结](https://javaguide.cn/ai/interview-questions/ai-system-design-interview-questions.html) | 2 年以上开发者、准备社招和系统设计面试的人 | 生产级 AI 应用架构、模型网关、Prompt 管理、RAG、Memory、Tool Calling、可观测、评测、安全合规、实时语音 Agent |
...
如果你发现自己只能背定义，讲不出生产里的影响，建议先看：[大模型基础面试题总结](https://javaguide.cn/ai/interview-questions/llm-interview-questions.html)。
...
- [RAG 面试题总结](https://javaguide.cn/ai/interview-questions/rag-interview-questions.html)
...
系统设计题建议直接看：[AI 系统设计面试题总结](https://javaguide.cn/ai/interview-questions/ai-system-design-interview-questions.html)。
...
- Token、上下文窗口、采样参数不清楚，就看[《LLM 运行机制》](https://javaguide.cn/ai/llm-basis/llm-operation-mechanism.html)。
- Function Calling、Structured Outputs、MCP 边界不清楚，就看[《大模型结构化输出详解》](https://javaguide.cn/ai/llm-basis/structured-output-function-calling.html)和[《万字拆解 MCP 协议》](https://javaguide.cn/ai/agent/mcp.html)。
- RAG 效果优化说不清楚，就看[《万字详解 RAG 检索优化》](https://javaguide.cn/ai/rag/rag-optimization.html)。
- 生产级 AI 应用架构说不清楚，就看[《AI 应用系统设计》](https://javaguide.cn/ai/system-design/ai-application-architecture.html)。
...
- [大模型基础面试题总结](https://javaguide.cn/ai/interview-questions/llm-interview-questions.html)
- [AI Agent 面试题总结](https://javaguide.cn/ai/interview-questions/agent-interview-questions.html)
- [RAG 面试题总结](https://javaguide.cn/ai/interview-questions/rag-interview-questions.html)
- [AI 系统设计面试题总结](https://javaguide.cn/ai/interview-questions/ai-system-design-interview-questions.html)
...
- 这篇文章是入口，帮你快速定位高频考点。
- [AI 应用开发专栏](https://javaguide.cn/ai/)是正文，帮你把每个考点背后的原理、工程细节和实践方案讲透。
