...
> 来源: https://javaguide.cn/system-design/security/why-password-reset-instead-of-retrieval.html

# 为什么忘记密码时只能重置，不能告诉你原密码？
[Guide](https://javaguide.cn/article/)系统设计数据安全密码安全哈希算法面试题约 2798 字大约 9 分钟这是一个挺有意思的问题，很多公司也在面试中问过。挺简单的，不知道大家平时在重置密码的时候有没有想过这个问题。
...
详细介绍可以阅读这篇文章：[简历别再写 MD5 加密密码了！](https://mp.weixin.qq.com/s?__biz=Mzg2OTA0Njk0OA==∣=2247542780&idx=1&sn=fb2fe3fb53fe596cc5b22e30766e0098&scene=21#wechat_redirect)
...
---
### 方案二：慢哈希算法（更推荐）
Bcrypt是专门为密码加密而设计的哈希算法，属于慢哈希算法。它内置了 salt 机制和 cost（成本）参数：
...
Java 应用程序的安全框架 Spring Security 官方推荐使用BCryptPasswordEncoder：
