...
> 来源: https://javaguide.cn/cs-basics/data-structure/graph.html

# 图详解（DFS、BFS、最短路径）
[Guide](https://javaguide.cn/article/)计算机基础数据结构约 1809 字大约 6 分钟
# 图
...
邻接链表使用一个链表来存储某个顶点的所有后继相邻顶点。对于图中每个顶点 Vi，把所有邻接于 Vi 的顶点 Vj 链成一个单链表，这个单链表称为顶点 Vi 的邻接表。如下图所示：
