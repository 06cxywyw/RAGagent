...
> 来源: https://javaguide.cn/cs-basics/network/osi-and-tcp-ip-model.html

# OSI 七层模型与 TCP/IP 四层模型详解
[Guide](https://javaguide.cn/article/)计算机基础计算机网络约 4003 字大约 13 分钟网络分层是学习计算机网络的第一张地图。没有这张地图，HTTP、TCP、IP、以太网、DNS 这些概念很容易堆在一起，分不清谁依赖谁、谁负责什么。
...
- OSI 七层模型每一层分别做什么？
- TCP/IP 四层模型和 OSI 七层模型如何对应？
- 为什么 OSI 模型理论完整，但实际没有成为互联网主流实现？
- 学习具体网络协议时，为什么要先知道它位于哪一层？

---
## OSI 七层模型
OSI 七层模型是国际标准化组织提出一个网络分层模型，其大体结构以及每一层提供的功能如下图所示：
...
- TCP 协议报文段结构可靠数据传输流量控制拥塞控制
- 报文段结构
- 可靠数据传输
- 流量控制
- 拥塞控制
- UDP 协议报文段结构RDT（可靠数据传输协议）
- 报文段结构
- RDT（可靠数据传输协议）
...
- Data Encapsulation and the TCP/IP Protocol Stack：[https://docs.oracle.com/cd/E19683-01/806-4075/ipov-32/index.html](https://docs.oracle.com/cd/E19683-01/806-4075/ipov-32/index.html)
