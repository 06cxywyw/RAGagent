...
> 来源: https://javaguide.cn/database/mysql/mysql-high-performance-optimization-specification-recommendations.html

# MySQL高性能优化规范建议总结
[Guide](https://javaguide.cn/article/)数据库MySQL约 5870 字大约 20 分钟作者: 听风 原文地址:[https://www.cnblogs.com/huchong/p/10219318.html](https://www.cnblogs.com/huchong/p/10219318.html)。
...
- 区分度最高的列放在联合索引的最左侧：这是最重要的原则。区分度越高，通过索引筛选出的数据就越少，I/O 操作也就越少。计算区分度的方法是count(distinct column) / count(*)。
